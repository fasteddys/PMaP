...
namespace PMaP.Data
{
    public class PortfolioMarketService
    {
        private IConfiguration Configuration { get; }
        public static int _portfolioId;

        public PortfolioMarketService(IConfiguration configuration)
        {
        ...
        public async Task<PortfolioMarketModel> Portfolios(string queryStrings)
        {
            ...
            {
                client.BaseAddress = new Uri(Configuration.GetConnectionString("portfoliosMarketUri"));
