...
namespace PMaP.Data
{
    public class PortfolioService
    {
        ...
        public async Task<PortfolioModel> Portfolios(string queryStrings)
        {
            ...
            {
                var portfolios = model.Documents.GroupBy(x => x.Portfolio1).Select(x => x.First()).OrderBy(x => x.Portfolio1).ToList();
            ...
            return new PortfolioModel { ViewModel = new ViewModel { PortfolioList = portfolioList, SubportfolioList = subportfolioList }, Documents = model.Documents };
        }
